...
export function TypeSpecificFields({ nodeType, register, control, setValue }: TypeSpecificFieldsProps) {
  switch (nodeType) {
    case "prompt":         return <PromptFields control={control} setValue={setValue} />;
    case "sub-agent":      return <SubAgentFields control={control} setValue={setValue} />;
    case "sub-agent-flow": return <SubAgentFlowFields register={register} />;
    case "skill":          return <SkillFields register={register} />;
