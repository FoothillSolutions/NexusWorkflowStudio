      ...
      <DialogContent showCloseButton={false} className="bg-zinc-900 border-zinc-700 text-zinc-100 max-w-3xl w-full max-h-[90vh] flex flex-col p-0">
        ...
        <div className="flex-1 overflow-hidden px-4 pb-4 pt-3">
          <textarea
            readOnly
            value={markdown}
            className="custom-scroll w-full h-full min-h-125 resize-none bg-zinc-950 text-zinc-200 text-xs font-mono leading-relaxed border border-zinc-700 rounded-lg p-4 outline-none select-all"
            spellCheck={false}
          />
        </div>
      </DialogContent>
