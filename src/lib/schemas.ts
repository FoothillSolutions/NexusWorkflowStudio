...
export { documentSchema }     from "@/nodes/document/constants";
...
const nodeDataSchema = z.object({ type: z.string(), label: z.string() }).loose();
...
const edgeSchema = z.object({ id: z.string(), source: z.string(), target: z.string() }).loose();
